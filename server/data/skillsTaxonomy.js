export const SKILLS_TAXONOMY = {
  ...
  "AI / ML & Data Engineering": [
    { name: "Machine Learning Fundamentals", aliases: ["ml", "machine learning", "scikit-learn", "supervised learning", "unsupervised learning"], tier: "core", weight: 0.8 },
    { name: "Deep Learning & PyTorch/TF", aliases: ["deep learning", "pytorch", "tensorflow", "keras", "neural networks", "cnn", "rnn"], tier: "advanced", weight: 0.85 },
    { name: "Generative AI & LLMs", aliases: ["genai", "llm", "llms", "gemini", "openai", "langchain", "llamaindex", "prompt engineering"], tier: "advanced", weight: 0.85 },
    { name: "Vector Databases & RAG", aliases: ["rag", "retrieval augmented generation", "vector database", "chromadb", "pinecone", "milvus", "qdrant", "embeddings"], tier: "advanced", weight: 0.8 },
    { name: "Data Engineering & Pipelines", aliases: ["spark", "apache spark", "airflow", "data pipelines", "etl", "bigquery", "data warehousing"], tier: "advanced", weight: 0.8 }
  ]
};

// Flattened helper list for fast lookup
export const ALL_SKILLS_FLAT = Object.entries(SKILLS_TAXONOMY).flatMap(([category, skills]) =>
